    ...
    >
      ...
      <Animated.View style={[styles.drawer, { transform: [{ translateX: drawerTranslate }] }]}>
        ...
        <TouchableOpacity
          onPress={() => {
            closeDrawer();
            navigation.navigate('Chat', { recipientId: 'test-user-id' });
          }}
        >
          <Text style={styles.menuItem}>Encrypted Messages</Text>
        <TouchableOpacity
          onPress={() => {
            closeDrawer();
            navigation.navigate('Chat', { recipientId: 'test-recipient-id' }); // 🔁 Replace with a real user id
          }}
        >
          <Text style={styles.menuItem}>→ Open Chat</Text>
        </TouchableOpacity>
