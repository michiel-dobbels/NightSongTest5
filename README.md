...
3. In the **Storage** section of Supabase create a bucket named `profile-images` and make it public. Profile pictures uploaded by users are stored here. The bucket name is defined in `lib/supabase.js` as `PROFILE_IMAGE_BUCKET`.
